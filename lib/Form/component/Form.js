...
var _validationRules = require('../../util/validationRules');
...
var Form = function (_React$Component) {
    ...
    _createClass(Form, [{
        ...
        value: function validation() {
            ...
            resultComponent = this.inputs.filter(function (component, index) {
                return !_validationRules.validations[component.props.validations](component.state._value) && component.state._required;
            });
        ...
        value: function render() {
            ...
            var nonFormsyProps = _objectWithoutProperties(this.props, []);

            return _react2.default.createElement(
                'form',
                _extends({}, nonFormsyProps, { onSubmit: function onSubmit(e) {
